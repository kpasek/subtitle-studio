...
class AppMenu:
    ...
    def create(self):
        ...
        gen_menu.add_command(label="Zmień plik z danymi", command=self.app.change_subtitle_file)
        ...
        gen_menu.add_command(label="Weryfikacja", command=self.app.open_verification_window, accelerator="Ctrl+Shift+Y")
        gen_menu.add_separator()
